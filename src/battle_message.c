...
static const u8 sText_WildPkmnAppeared[] = _("A wild {B_OPPONENT_MON1_NAME} attacks!\p");
static const u8 sText_LegendaryPkmnAppeared[] = _("{B_OPPONENT_MON1_NAME} approaches.\p");
static const u8 sText_WildPkmnAppearedPause[] = _("A wild {B_OPPONENT_MON1_NAME} attacks!{PAUSE 127}");
static const u8 sText_TwoWildPkmnAppeared[] = _("A wild {B_OPPONENT_MON1_NAME} and {B_OPPONENT_MON2_NAME} attack!\p");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNGAINEDEXP]                        = COMPOUND_STRING("Your team gained{B_BUFF2} {B_BUFF3} Exp. Points!\p"),
    ...
    [STRINGID_MOVEPOWERSUP]                         = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX}'s move was powered up!"),
    ...
    [STRINGID_PKMNTOOKMOONLIGHT]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} gathers energy from the Moon!"),
    ...
    [STRINGID_GOTMATERIALAFTERBATTLE]               = COMPOUND_STRING("The Pokémon dropped {B_BUFF1}!\p"),
    [STRINGID_GOTMATERIALAFTERBATTLEDOUBLE]         = COMPOUND_STRING("You Pokémon dropped {B_BUFF1}/nand {B_BUFF2}!\p"),
    ...
    [STRINGID_DONTLEAVEBIRCH]                       = COMPOUND_STRING("The Pokémon blocks the way!\p"), //no decapitalize until it is everywhere
    ...
    [STRINGID_PKMNSXPREVENTSFROSTBITE]              = COMPOUND_STRING("{B_EFF_NAME_WITH_PREFIX}'s {B_EFF_ABILITY} prevents frostbite!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNSXINTENSIFIEDMOON]                 = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} purified the moonlight!"), //not in gen 5+, ability popup
    ...
    [STRINGID_PKMNALREADYFROSTBITTEN]               = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} is already frostbitten!"),
    ...
    [STRINGID_PKMNABILITYRESTOREDHPALITTLE]        = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX} restored a little HP thanks to {B_ATK_ABILITY}!"),
    ...
    [STRINGID_MOONLIGHTHPGAIN]                      = COMPOUND_STRING("The pure moon healed {B_ATK_NAME_WITH_PREFIX} a little bit!"),
    ...
    [STRINGID_MOONSHINES]                           = COMPOUND_STRING("The pure moon shines."),
    [STRINGID_FOGLIFTED]                            = COMPOUND_STRING("The fog lifted."),
    [STRINGID_MOONPURIFIED]                         = COMPOUND_STRING("The moonlight was purified!"),
    [STRINGID_MOONDISAPPEARED]                      = COMPOUND_STRING("The moonlight went back to normal."),
...
const u16 gMoveWeatherChangeStringIds[] =
{
    ...
    [B_MSG_STARTED_MOON]      = STRINGID_MOONPURIFIED,
};
...
const u16 gWeatherEndsStringIds[B_MSG_WEATHER_END_COUNT] =
{
    ...
    [B_MSG_WEATHER_END_MOON]         = STRINGID_MOONDISAPPEARED,
...
const u16 gWeatherTurnStringIds[] =
{
    ...
    [B_MSG_WEATHER_TURN_MOON]          = STRINGID_MOONSHINES,
