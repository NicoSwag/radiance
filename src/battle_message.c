...
static const u8 sText_WildPkmnAppeared[] = _("A wild {B_OPPONENT_MON1_NAME} attacks you!\p");
static const u8 sText_LegendaryPkmnAppeared[] = _("{B_OPPONENT_MON1_NAME} approaches.\p");
static const u8 sText_WildPkmnAppearedPause[] = _("A wild {B_OPPONENT_MON1_NAME} attacks you!{PAUSE 127}");
static const u8 sText_TwoWildPkmnAppeared[] = _("A wild {B_OPPONENT_MON1_NAME} and {B_OPPONENT_MON2_NAME} attack you!\p");
