...
const u8 gText_OptionMenuWildBattles[] = _("Wild Battle Speed");
const u8 gText_OptionMenuTrainerBattles[] = _("Trainer Battle Speed");
const u8 gText_OptionMenuImportantBattles[] = _("Important Battle Speed");
...
const u8 gText_BattleSpeed[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}x");
...
const u8 gText_YourName[] = _("The name is…");
