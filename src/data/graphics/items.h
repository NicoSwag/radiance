...
const u32 gItemIconPalette_StellarTMHM[] = INCBIN_U32("graphics/items/icon_palettes/stellar_tm_hm.gbapal.lz");

const u32 gItemIconPalette_SoundTMHM[] = INCBIN_U32("graphics/items/icon_palettes/sound_tm_hm.gbapal.lz");
