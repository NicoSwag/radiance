...
const struct EvenCraftingUiTemplate sECU_Templates[ECU_TEMPLATE_NUMBER] =
{
    [ECU_DEFAULT] =
    {
        ...
        .maxIngredients = 6,
        .outputX = 80 + 16 + 2 * (240 - 80 - 16) / 4,
        .outputY = 3 * (160 - 16) / 4,
        .positions =
        {
            {80 + 16 + 1 * (240 - 80 - 16) / 4,  1 * (160 - 16) / 4},
            {80 + 16 + 2 * (240 - 80 - 16) / 4,  1 * (160 - 16) / 4},
            {80 + 16 + 3 * (240 - 80 - 16) / 4,  1 * (160 - 16) / 4},

            {80 + 16 + 1 * (240 - 80 - 16) / 4,  2 * (160 - 16) / 4},
            {80 + 16 + 2 * (240 - 80 - 16) / 4,  2 * (160 - 16) / 4},
            {80 + 16 + 3 * (240 - 80 - 16) / 4,  2 * (160 - 16) / 4},
        },
    },
};
