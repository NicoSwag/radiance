...
#define PSN_RS (B_UPDATED_TYPE_MATCHUPS >= GEN_2 ? X(0.5) : X(1.5))  // Bug        -> Poison
#define BUG_RS (B_UPDATED_TYPE_MATCHUPS >= GEN_2 ? X(1.0) : X(1.5))  // Poison     -> Bug
#define PSY_RS (B_UPDATED_TYPE_MATCHUPS >= GEN_2 ? X(1.5) : X(0.0))  // Ghost      -> Psychic
...
{//                   Defender -->
 //  Attacker           None   Normal Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy   Stellar  Sound
    ...
    [TYPE_FIGHTING] = {______, X(1.5), ______, X(0.5), X(0.5), ______, X(1.5), X(0.5), X(0.0), X(1.5), ______, ______, ______, ______, ______, X(0.5), X(1.5), ______, X(1.5), X(0.5), ______, ______},
    [TYPE_FLYING]   = {______, ______, X(1.5), ______, ______, ______, X(0.5), X(1.5), ______, X(0.5), ______, ______, ______, X(1.5), X(0.5), ______, ______, ______, ______, ______, X(0.5), ______},
    [TYPE_POISON]   = {______, ______, ______, ______, X(0.5), X(0.5), X(0.5), BUG_RS, X(0.5), X(0.0), ______, ______, ______, X(1.5), ______, ______, ______, ______, ______, X(1.5), ______, X(1.5)},
    [TYPE_GROUND]   = {______, ______, ______, X(0.0), X(1.5), ______, X(1.5), X(0.5), ______, X(1.5), ______, X(1.5), ______, X(0.5), X(1.5), ______, ______, ______, ______, ______, ______, X(0.5)},
    [TYPE_ROCK]     = {______, ______, X(0.5), X(1.5), ______, X(0.5), ______, X(1.5), ______, X(0.5), ______, X(1.5), ______, ______, ______, ______, X(1.5), ______, ______, ______, X(1.5), ______},
    [TYPE_BUG]      = {______, ______, X(0.5), X(0.5), PSN_RS, ______, ______, ______, X(0.5), X(0.5), ______, X(0.5), ______, X(1.5), ______, X(1.5), ______, ______, X(1.5), X(0.5), ______, ______},
    [TYPE_GHOST]    = {______, X(0.0), ______, ______, ______, ______, ______, ______, X(1.5), STL_RS, ______, ______, ______, ______, ______, PSY_RS, ______, ______, X(0.5), ______, X(0.5), ______},
    [TYPE_STEEL]    = {______, ______, ______, ______, ______, ______, X(1.5), ______, ______, X(0.5), ______, X(0.5), X(0.5), ______, X(0.5), ______, X(1.5), ______, ______, X(1.5), ______, X(0.5)},
    ...
    [TYPE_FIRE]     = {______, ______, ______, ______, ______, ______, X(0.5), X(1.5), ______, X(1.5), ______, X(0.5), X(0.5), X(1.5), ______, ______, X(1.5), X(0.5), ______, ______, ______, ______},
    [TYPE_WATER]    = {______, ______, ______, ______, ______, X(1.5), X(1.5), ______, ______, ______, ______, X(1.5), X(0.5), X(0.5), ______, ______, ______, X(0.5), ______, ______, ______, ______},
    [TYPE_GRASS]    = {______, ______, ______, X(0.5), X(0.5), X(1.5), X(1.5), X(0.5), ______, X(0.5), ______, X(0.5), X(1.5), X(0.5), ______, ______, ______, X(0.5), ______, ______, ______, ______},
    [TYPE_ELECTRIC] = {______, ______, ______, X(1.5), ______, X(0.0), ______, ______, ______, ______, ______, ______, X(1.5), X(0.5), X(0.5), ______, ______, X(0.5), ______, ______, ______, X(1.5)},
    [TYPE_PSYCHIC]  = {______, ______, X(1.5), ______, X(1.5), ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, ______, X(0.5), ______, ______, X(0.0), ______, ______, X(1.5)},
    [TYPE_ICE]      = {______, ______, ______, X(1.5), ______, X(1.5), ______, ______, ______, X(0.5), ______, FIR_RS, X(0.5), X(1.5), ______, ______, X(0.5), X(1.5), ______, ______, X(1.5), ______},
    [TYPE_DRAGON]   = {______, ______, ______, ______, ______, ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, ______, ______, ______, X(1.5), ______, X(0.0), ______, ______},
    [TYPE_DARK]     = {______, ______, X(0.5), ______, ______, ______, ______, ______, X(1.5), STL_RS, ______, ______, ______, ______, ______, X(1.5), ______, ______, X(0.5), X(0.5), X(0.5), ______},
    [TYPE_FAIRY]    = {______, ______, X(1.5), ______, X(0.5), ______, ______, ______, ______, X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, X(1.5), X(1.5), ______, X(0.5), ______},
    [TYPE_STELLAR]  = {______, ______, ______, ______, ______, ______, X(0.5), ______, ______, ______, ______, X(1.5), ______, ______, ______, ______, X(0.5), ______, ______, X(1.5), ______, X(0.0)},
    [TYPE_SOUND]    = {______, ______, ______, ______, ______, X(1.5), ______, X(0.5), ______, X(1.5), ______, ______, X(1.5), X(0.5), X(0.5), ______, X(0.5), ______, ______, ______, X(0.0), ______},
};
...
const struct TypeInfo gTypesInfo[NUMBER_OF_MON_TYPES] =
{
    ...
    [TYPE_STELLAR] =
    {
        ...
        .maxMove = MOVE_MAX_STRIKE,
        .teraTypeRGBValue = RGB(10, 18, 27),
        .paletteTMHM = gItemIconPalette_StellarTMHM, // failsafe
        .useSecondTypeIconPalette = TRUE,
        .isSpecialCaseType = FALSE,
        .isHiddenPowerType = FALSE,
    ...
    [TYPE_SOUND] =
    {
        ...
        .maxMove = MOVE_MAX_STRIKE,
        .teraTypeRGBValue = RGB(10, 18, 27),
        .paletteTMHM = gItemIconPalette_SoundTMHM, // failsafe
        .useThirdTypeIconPalette = TRUE,
        .isSpecialCaseType = FALSE,
        .isHiddenPowerType = FALSE,
        // .teraShard = ITEM_STELLAR_TERA_SHARD,
    },
