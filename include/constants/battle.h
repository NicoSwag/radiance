...
#define BATTLE_TYPE_IMPORTANT          (1 << 14)
...
#define B_WEATHER_MOON          (1 << BATTLE_WEATHER_MOON)

#define B_WEATHER_ANY           (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_HAIL | B_WEATHER_STRONG_WINDS | B_WEATHER_SNOW | B_WEATHER_FOG| B_WEATHER_MOON)
