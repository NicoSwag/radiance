...
#define ITEM_BRITTLE_ROCK 830

#define ITEM_BEFORE_MATERIAL ITEM_BRITTLE_ROCK

#define ITEM_ZUBAT_FANG ITEM_BEFORE_MATERIAL + 1
#define ITEM_VENOM_SAMPLE ITEM_BEFORE_MATERIAL + 2
